...
//            System.out.println(coordsAfterExpansion);
    ...
    private static List<Long> findEmptySlicesOfSpace(List<Coord> positions,
                                                     Function<Coord, Long> xySelector,
                                                     int totalSize) {
    ...
    private static List<Coord> expandSpace(List<Coord> positions,
